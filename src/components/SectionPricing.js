            ...
            <section id={_.get(section, 'section_id', null)} className={'block pricing-block bg-' + _.get(section, 'background', null) + ' outer'}>
              <div className="block-header inner-small">
                ...
                <p className="block-subtitle">
                  ...
                  <a href="javascript:void(Tawk_API.toggle())"> Contact Us </a>
             ...
             <small>*Server cost will increase depending on users/traffic.</small> 
             <br/>
<small>*Customizations in the existing platform are available on demand and will be chargeable. </small>
              </div>
